...
class MY_Model extends CI_Model
{
	...
	* ------------------------------------------------------------ */
	...
	/**
	 * Fetch multiple records based on an arbitrary LIKE call. Can be
	 * any valid value to $this->db->like().
	 */
	public function get_many_like()
	{
		//capture the limit and offset, before doing a reset.
		//reset is essential to clear previous sql statement.
		//doing so will result in loosing the limit.
		$limit = $this->_database->ar_limit;
		$offset = $this->_database->ar_offset;
	...
	private function _set_like($params)
	{
		...
		else
		{
			...
			$this->_database->like($params[0], $params[1], $side);
		}
	}
}